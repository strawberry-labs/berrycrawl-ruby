...
describe Berrycrawl::Internal::Types::Utils do
  Utils = Berrycrawl::Internal::Types::Utils

  module TestUtils
    class M < Berrycrawl::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Berrycrawl::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Berrycrawl::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Berrycrawl::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Berrycrawl::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Berrycrawl::Internal::Types::Array[String]
      ModelArray = -> { Berrycrawl::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Berrycrawl::Internal::Types::Array[TestUtils::U] }
