...
describe Berrycrawl::Internal::Types::Union do
  class Rectangle < Berrycrawl::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Berrycrawl::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Berrycrawl::Internal::Types::Model
